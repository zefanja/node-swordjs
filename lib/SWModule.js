...
var SWMgr = require("./SWModuleMgr.js");
var vkey = require("./VerseKey.js");
var ztext = require("./zTextReader.js");
var SWFilter = require("./SWFilter.js");
...
var mod = module.exports = function (inName, inCallback) {
    ...
    this.renderText = function (inVerseKey, inOptions, inCallback) {
        ...
        ztext.getChapterBytes(path.join(SWMgr.getGlobalPath(), this.configData.DataPath), inVerseKey, function (inData) {
            inCallback(SWFilter.processText(inData, inOptions));
        });
